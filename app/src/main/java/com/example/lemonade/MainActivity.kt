...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when(this.lemonadeState){
            SELECT -> imageAction.setImageResource(R.drawable.lemon_tree)
            SQUEEZE ->  imageAction.setImageResource(R.drawable.lemon_squeeze)
            DRINK ->  imageAction.setImageResource(R.drawable.lemon_drink)
            RESTART -> imageAction.setImageResource(R.drawable.lemon_restart)
